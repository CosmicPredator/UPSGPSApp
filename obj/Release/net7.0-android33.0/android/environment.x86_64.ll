...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"a3bec6ac-1c5c-4f39-bc87-8c617395d4be\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [26 x i8] c"com.companyname.upsgeoapp\00", align 16
...
@__DSOCacheEntry_name.2 = internal constant [24 x i8] c"libaot-UPSGeoApp.dll.so\00", align 16
...
@__DSOCacheEntry_name.62 = internal constant [31 x i8] c"libaot-GeolocatorPlugin.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [464 x %struct.DSOCacheEntry] [
	...
	; 1
	%struct.DSOCacheEntry {
		i64 114057827429476576, ; hash 0x19536fd5fc968e0, from name: UPSGeoApp
		i8 0, ; ignore
	...
	; 25
	%struct.DSOCacheEntry {
		i64 979961892568873680, ; hash 0xd99862633fcbad0, from name: libaot-UPSGeoApp.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([24 x i8], [24 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 112
	%struct.DSOCacheEntry {
		i64 4938038435001444443, ; hash 0x44876fcb357ca85b, from name: GeolocatorPlugin.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__DSOCacheEntry_name.62, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 113
	%struct.DSOCacheEntry {
	...
	; 132
	%struct.DSOCacheEntry {
		i64 6216061204437183814, ; hash 0x5643e2bb3890ad46, from name: libaot-GeolocatorPlugin.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__DSOCacheEntry_name.62, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 182
	%struct.DSOCacheEntry {
		i64 8022745892557429661, ; hash 0x6f5684e2091c1b9d, from name: aot-GeolocatorPlugin
		i8 0, ; ignore
		i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__DSOCacheEntry_name.62, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 187
	%struct.DSOCacheEntry {
		i64 8220747139587616837, ; hash 0x7215f5f7d36db045, from name: libaot-UPSGeoApp
		i8 0, ; ignore
		i8* getelementptr inbounds ([24 x i8], [24 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 213
	%struct.DSOCacheEntry {
		i64 8902340828949851143, ; hash 0x7b8b77d13b032c07, from name: libaot-GeolocatorPlugin
		i8 0, ; ignore
		i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__DSOCacheEntry_name.62, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 225
	%struct.DSOCacheEntry {
		i64 9249196297280434506, ; hash 0x805bbf072d42314a, from name: aot-GeolocatorPlugin.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__DSOCacheEntry_name.62, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 290
	%struct.DSOCacheEntry {
		i64 11837793004162706657, ; hash 0xa4484a0499b8ece1, from name: aot-UPSGeoApp
		i8 0, ; ignore
		i8* getelementptr inbounds ([24 x i8], [24 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 355
	%struct.DSOCacheEntry {
		i64 14115235932722986807, ; hash 0xc3e3644b8ac87f37, from name: UPSGeoApp.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([24 x i8], [24 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 428
	%struct.DSOCacheEntry {
		i64 17053396256167459672, ; hash 0xeca9d58aced67b58, from name: aot-UPSGeoApp.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([24 x i8], [24 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 451
	%struct.DSOCacheEntry {
		i64 18096487346344890275, ; hash 0xfb23a35cb93d0fa3, from name: GeolocatorPlugin
		i8 0, ; ignore
		i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__DSOCacheEntry_name.62, i32 0, i32 0), ; name
		i8* null; handle
	}, 
